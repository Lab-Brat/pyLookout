...
class Collector():
    ...
    def __post_init__(self):
        self.cpu_detail = {f'Core{i}': p for i, p in enumerate(
        ...
        self.partitions = [part for part in disk_partitions()
                                if 'loop' not in part.device and
                                   'boot' not in part.mountpoint]
